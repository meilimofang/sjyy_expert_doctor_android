 ...
 * @author 海洋
 */
public class DoctorMyReservationActivity extends BaseActivity implements
		IXListViewListener {
...
//			ImageView iv_my_appointment_zuo,iv_my_appointment_shu,iv_my_appointment_hui;
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(DoctorMyReservationActivity.this)
...
//				holder.iv_my_appointment_hui=(ImageView) convertView.findViewById(R.id.iv_my_appointment_hui);
			...
			holder.tv_patient_name
					.setText(base.orderList.get(position).hospitalName);
			...
			holder.bt_patient_details.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					intent.setClass(DoctorMyReservationActivity.this,
	...
	class dataThread extends Thread {
		...
		public void run() {
			...
			bean.userId = ShareUtil.getAccountId(DoctorMyReservationActivity.this);
			Object data = NetRequestEngine.getDoctorOrderList(bean);
