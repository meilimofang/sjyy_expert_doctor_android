 ...
 * @author 海洋
 */
public class HospitalChooseAreaActivity extends BaseActivity {
	...
	private void initview() {
		...
		lv_chose_area.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.setClass(HospitalChooseAreaActivity.this, HospitalChooseCityActivity.class);
	...
	class dataAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			ViewHolder holder;
			if (convertView == null) {
				convertView = LayoutInflater.from(HospitalChooseAreaActivity.this).inflate(
